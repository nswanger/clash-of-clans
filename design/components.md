...
**Members:** metric tile, list header, facts grid, evidence list, freshness line (timestamps only — [#124](https://github.com/nswanger/clash-of-clans/issues/124) removed the window rule beneath the war record), filter choices, window row.
