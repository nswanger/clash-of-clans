...
- **Overall player rating**: A 0–100 CWL evidence summary combining current-CWL attack completion with prior regular-war attack performance when those facts exist. It is a reference signal for CWL review, not a regular-war lineup rule or an automatic decision.
