...
- **Planned lineup**: The leader-owned lineup for one CWL war day. Each day is an independent snapshot after its initial seed, which is the collected war roster when the day has been observed and otherwise the prior day's plan ([0009](docs/decisions/0009-planned-and-observed-lineups-stay-distinct.md)).
